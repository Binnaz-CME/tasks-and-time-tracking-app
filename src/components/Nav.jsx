    ...
    <div className="w-full h-screen">
      ...
      >
        <nav id="tabs" className="flex justify-between">
            <Link className="w-full focus:text-teal-500 hover:text-teal-500 justify-center inline-block text-center pt-2 pb-1">
              <MdOutlineHome size='2.2em' className="width=25 height=25 inline-block mb-1" />
              <span className="block text-s">Home</span>
            </Link>
            <Link className="w-full focus:text-teal-500 hover:text-teal-500 justify-center inline-block text-center pt-2 pb-1">
              <MdOutlineCalendarToday size='2em' className="width=25 height=25 inline-block mb-1" />
